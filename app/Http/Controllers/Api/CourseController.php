...
class CourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Đây là cách sửa lỗi "Undefined variable $query" nếu bạn muốn thêm tính năng tìm kiếm
        ...
        // SỬA ĐỔI: Sắp xếp theo updated_at mới nhất (giảm dần)
        // Phương thức latest() tương đương với orderBy('created_at', 'desc') hoặc orderBy('updated_at', 'desc')
        // Tùy theo cấu hình Eloquent, ở đây ta dùng updated_at để chắc chắn
    ...
    {
        try {
             // SỬA LỖI: Luôn sử dụng with('department') để tải đầy đủ thông tin
